...
INSERT INTO publication(id, address, created, description, publishing_type, tariff, time_required_or_offered, user_id, work_area_id)
VALUES (2, 'Av. Oquendo #7604', '2021-03-20', 'Construcción y montaje de estructuras, perfiles metálicos, costaneras, galvanizado, livianos o viga de madera, para cubiertas de columnas, singles, tejas cerámicas, policarbonatos, lunas mallas + cielo Drywall, PVC, presupuestos.', 'OFFER', 2200, 21, 1, 5);
...
INSERT INTO publication(id, address, created, description, publishing_type, tariff, time_required_or_offered, user_id, work_area_id)
VALUES (6, 'Empresa de limpieza requiere personal con experiencia en lavado de alfombras y otros, que sepa utilizar maquinas, con preferencia varón.', 'DEMAND', 2100, 30, 1, 1);
